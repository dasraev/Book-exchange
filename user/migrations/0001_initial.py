    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(max_length=100, null=True)),
                ('country', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='regions', to='user.country')),
            ],
        ),
        migrations.CreateModel(
            name='MyUser',
            fields=[
                ...
                ('profile_pic', models.ImageField(blank=True, default='profile-pics/default_pic.jpg', null=True, upload_to='profile-pics/')),
