...
from .views import ProfileView, CustomPasswordResetView, regions_by_country
...
urlpatterns = [
    ...
    path('password-reset/', CustomPasswordResetView.as_view(template_name='user/password_reset.html'),
         name='password-reset'),
